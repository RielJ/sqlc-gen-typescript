...
${query.text}`
      ...
      if (nodes) {
        ...
        files.push(
          new File({
            name: outputFilename,
            contents: new TextEncoder().encode(printNode(nodes, header)),
          })
        );
      }
    }
...
function printNode(nodes: Node[], header?: string): string {
  ...
  let output = header ?? "// Code generated by sqlc. DO NOT EDIT.\n\n";
