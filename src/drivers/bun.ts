...
export interface BunOptions {
  /** Output filename suffix, e.g. "queries" for "<name>.queries.ts" or "sql" for "<name>_sql.ts" (default) */
  filename_suffix?: string;
  /** Whether to add @ts-nocheck comment to the generated file (default: false) */
  ts_nocheck?: boolean;
}
...
export class Driver {
  private readonly options: BunOptions;

  constructor(options?: BunOptions) {
    this.options = options ?? {};
  }

  header(): string | undefined {
    if (this.options.ts_nocheck) {
  ...
  formatFilename(filename: string): string | undefined {
    const suffix = this.options.filename_suffix;
    if (suffix) {
